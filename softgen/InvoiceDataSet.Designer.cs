...
namespace softgen {
    ...
    public partial class InvoiceDataSet : global::System.Data.DataSet {
        ...
        public partial class invoiceDataTable : global::System.Data.TypedTableBase<invoiceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public invoiceRow AddinvoiceRow(string hsn_code, decimal qty, decimal mrp, decimal sale_price, decimal disc_per, decimal net_amt, string item_desc) {
...
namespace softgen.InvoiceDataSetTableAdapters {
    ...
    public partial class invoiceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `invoice` (`hsn_code`, `qty`, `mrp`, `sale_price`, `disc_per`, `net_a" +
                "mt`, `item_desc`) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `hsn_code`, `qty`, `mrp`, `sale_price`, `disc_per`, `net_amt`, `item_desc`" +
                " FROM `invoice`";
        ...
        public virtual int Insert(string hsn_code, decimal qty, decimal mrp, decimal sale_price, decimal disc_per, decimal net_amt, string item_desc) {
            if ((hsn_code == null)) {
                throw new global::System.ArgumentNullException("hsn_code");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(hsn_code));
            }
            this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(qty));
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(mrp));
            this.Adapter.InsertCommand.Parameters[3].Value = ((decimal)(sale_price));
            this.Adapter.InsertCommand.Parameters[4].Value = ((decimal)(disc_per));
            this.Adapter.InsertCommand.Parameters[5].Value = ((decimal)(net_amt));
            if ((item_desc == null)) {
                throw new global::System.ArgumentNullException("item_desc");
            }
            else {
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(item_desc));
            }
